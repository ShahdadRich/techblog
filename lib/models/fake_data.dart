...
Map homePagePosterMap = {
  'imageAssets': Assets.images.mainpagePoster.path,
  'writer': 'ملیکا عزیزی',
  'uploadDate': 'یک روز پیش',
  'view': '2000',
  'titel': 'دوازده قدم برنامه نویسی یک دوره',
};

// hastag list fake data
...
List<PodCastModel> podCastList = [
  PodCastModel(image: Assets.images.ramezonImage.path, titel: 'رمزون'),
  PodCastModel(image: Assets.images.radioImage.path, titel: 'رادیو کدیاد'),
  PodCastModel(image: Assets.images.technoImages.path, titel: 'تکنوکست'),
  PodCastModel(image: Assets.images.padiCastImages.path, titel: 'پادی کست')
];
